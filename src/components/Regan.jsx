  ...
  return (
    <>
      <div className='letterBlock'>
        <h3>Proclamation 5030</h3>
        <p className='titillium-web-regular'>March 10, 1983
          ...
          [Filed with the Office of the Federal Register, 10:20 a.m., March 11, 1983]

          Date
          03/10/1983</p>
        <img src="./src/assets/reagansignature.png" alt="Regans Sig" height='100' />
        <div>
        <button className="progressButton titillium-web-regular">That's some great progress, but what now?</button>
        </div>
